...
volatile float Control_km1, Error_km1;
...
void ControlLoop()
{
  ...
  Sensor_Input = adc->adc0->analogRead(A1);          				  // Read Analog value channel A1 (AD) - Sensor Input (0-3.3 volts) after the B2SE circuit
	...
	Control = 2.018*Error - 1.976*Error_km1 + 0.9581*Control_km1;   // Control (units are voltage  +- 10 volts)  This equation impliments the control equation
